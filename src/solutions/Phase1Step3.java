...
public class Phase1Step3 {
    ...
    public static void main(String[] args) {
        ...
        // Test moved to Phase1Step4VarianceReduction.testVarianceReductionForest()
    }
     ...
     * */
    static double[] meanGradesOfTabulation(int courseId, Feature splitFeature) {
     ...
     */
    static double calculateVariance(ArrayList<Double> numbers) {
        if (numbers.isEmpty()) {
            return -1;
        }
