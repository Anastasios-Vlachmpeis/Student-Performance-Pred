...
public class Main {
    public static void main(String[] args) {
        ...
        Phase1Step1Methods.printBestAndWorstCourse();

        // Question 2
        System.out.println("Answering Step 1- Question 2");
        Phase1Step1Methods.printCumLaudeStudents();
        ...
        Phase1Step1Methods.printTopKCorrelatedCoursePairs(TOP_K);
        ...
        Phase1Step2Methods.printHardestAndEasiestCourses();
        ...
        Phase1Step2Methods.printTopKCorrelatedCoursePairsIgnoreNG(TOP_K);
        // Q4 (extra): Adjusted Q4 for current grades
        System.out.println("Answering Step 2 - Question 4");
        Phase1Step2Methods.analyzeStudentPerformanceHardVsEasyNG();
        ...
        int MAX_RESITS = 3;
        System.out.println("Guess: " + Phase1Step2Methods.predictGraduateAmountMonteCarloSimulation(ITERATIONS, MAX_RESITS) + " will graduate.");
